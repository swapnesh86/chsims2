        ...
        <>
            <div className="billing--line2">
                ...
                <select id="name" name="name" size="1" value={name} onChange={(e) => setName(e.target.value)} >
                    {[<option></option>, <option>Ankita</option>, <option>Aditi</option>, <option>Poonam</option>, <option>Kirti</option>, <option>Sanika</option>, <option>Sanchi</option>, <option>Neha</option>, <option>Minakshi</option>, <option>Vaishnavi</option>]}
                </select>
            </div>
